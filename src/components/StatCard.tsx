  ...
  return (
    <div className="group relative overflow-hidden rounded-2xl border border-white/15 bg-ink-900/45 p-6 backdrop-blur-xl transition hover:-translate-y-1 hover:border-white/35">
      ...
      <div className="relative flex items-center justify-between">
        <span className="grid h-10 w-10 place-items-center rounded-xl bg-moss-500/10 text-moss-400 ring-1 ring-moss-500/25">
          {icon}
        </span>
        {hint && <span className="text-[10px] uppercase tracking-[0.2em] text-moss-400/80">{hint}</span>}
      </div>
